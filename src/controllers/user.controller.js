...
const registerUser = asyncHandler(async (req, res) => {
  ...
  const user = await User.create({
    // User is of mongodb use in capital U
    fullname,
    avatar: avatar.url,
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  //todo add method for deleting old avatar from cloudinary
  // const oldAvatarDelete = await User.findByIdAndDelete(req.user._id,
  //   {
  //     $unlink: {
  //       avatar: 1, // this removes the field from document
  //     },
  //   }
  // );
...
const getUserChannelProfile = asyncHandler(async (req, res) => {
  ...
  .status(200)
  .json(
    new ApiResponse(200, channel[0], "channel fetched successsfully")
  )
});
